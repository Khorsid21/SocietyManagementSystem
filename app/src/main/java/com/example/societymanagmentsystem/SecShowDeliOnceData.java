...
public class SecShowDeliOnceData {
    ...
    @Expose
    private String _8;
    @SerializedName("ODdate")
    @Expose
    private String oDdate;
    @SerializedName("9")
    @Expose
    private String _9;
    @SerializedName("ODtime")
    @Expose
    private String oDtime;
    @SerializedName("10")
    @Expose
    private String _10;
    @SerializedName("ODvalidity")
    @Expose
    private String oDvalidity;
    @SerializedName("11")
    @Expose
    private String _11;
    ...
    public String getODvalidity() {
        return oDvalidity;
    }

    public void setODvalidity(String oDvalidity) {
        this.oDvalidity = oDvalidity;
    }
