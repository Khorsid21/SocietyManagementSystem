...
public class AdapterSecDeliFreq extends RecyclerView.Adapter<AdapterSecDeliFreq.myviewholder> {
    ...
    private static final String UPLOAD_URL1 = "https://vivek.ninja/Delivery/deli_freq_allow.php";
    private static final String UPLOAD_URL2 = "https://vivek.ninja/Delivery/deli_freq_deny.php";

    public AdapterSecDeliFreq(Context context, Activity activity, List<SecShowDeliFreqData> productList) {
        //this.data = data;
    ...
    @NonNull
    @Override
    public AdapterSecDeliFreq.myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(parent.getContext());
        View view = inflater.inflate(R.layout.custom_secshow_deli_freq, parent, false);
        return new AdapterSecDeliFreq.myviewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterSecDeliFreq.myviewholder holder, int position) {
        SecShowDeliFreqData product = productList.get(position);
        ...
        holder.stime.setText(product.getODstarttime());
        holder.etime.setText(product.getODendtime());
        ...
        holder.fvalidity.setText(product.getODvaldays());
        holder.fstime.setText(product.getODstarttime());
        holder.fetime.setText(product.getODendtime());
        String strMain = product.getODdays();
            ...
            public void onClick(View view) {
                ...
                StringRequest sr = new StringRequest(POST, UPLOAD_URL1,
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    if(!res.contains("Fail")){
                                        ...
                                        reasonTv.setText("Frequent Time Delivery Allowance Request is Accepted Successfully !");
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        map.put("Odays",product.getODdays());
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    if(!res.contains("Fail")){
                                        ...
                                        ImageView reasonIv = (ImageView) mViewi.findViewById(R.id.reponse_image);
                                        Button reasonBtn = (Button) mViewi.findViewById(R.id.response_button);
                                        reasonTv.setText("Frequent Time Delivery Allowance Request is Rejected Successfully !");
                                        reasonTv.setTextColor(activity.getResources().getColor(R.color.responsePositive));
                                        reasonBtn.setText("OK");
                                        reasonIv.setBackground(activity.getResources().getDrawable(R.drawable.check));
                                        final AlertDialog dialogi = alertDialogBuilderUserInput.create();
    ...
    public class myviewholder extends RecyclerView.ViewHolder {
        ...
        public myviewholder(@NonNull View itemView) {
            super(itemView);
            name = (TextView) itemView.findViewById(R.id.secdelif_custom_Uname);
            phone = (TextView) itemView.findViewById(R.id.secdelif_custom_Utype);
            stime = (TextView) itemView.findViewById(R.id.secdelif_custom_Ustime);
            etime = (TextView) itemView.findViewById(R.id.secdelif_custom_Uetime);

            fname = (TextView) itemView.findViewById(R.id.secdeliftvUName);
            fphone = (TextView) itemView.findViewById(R.id.secdeliftvUMob1);
            femail = (TextView) itemView.findViewById(R.id.secdeliftvUemail);
            fcity = (TextView) itemView.findViewById(R.id.secdeliftvUcity);
            fsoc = (TextView) itemView.findViewById(R.id.secdeliftvUsocname);
            fblck = (TextView) itemView.findViewById(R.id.secdeliftvUblock);
            fvalidity = (TextView) itemView.findViewById(R.id.secdeliftvvalper);
            fstime = (TextView) itemView.findViewById(R.id.secdeliftvUstime);
            fetime = (TextView) itemView.findViewById(R.id.secdeliftvUetime);
            fDays = (TextView) itemView.findViewById(R.id.secdeliftvUdays);
            fstatustv = (TextView) itemView.findViewById(R.id.secdeliftvOStatus);

            allow = (ImageView) itemView.findViewById(R.id.secdelifAllowCabBtn);
            deny = (ImageView) itemView.findViewById(R.id.secdelifDenyCabBtn);
            statusImage = (ImageView) itemView.findViewById(R.id.secdelif_Ustatus);

            final FoldingCell fc = itemView.findViewById(R.id.folding_cell_deli_freq_list);
