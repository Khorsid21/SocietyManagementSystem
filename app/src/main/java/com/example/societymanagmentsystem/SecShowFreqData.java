...
public class SecShowFreqData {
    ...
    @Expose
    private String _8;
    @SerializedName("Odays")
    @Expose
    private String odays;
    @SerializedName("9")
    @Expose
    private String _9;
    @SerializedName("Ovaldays")
    @Expose
    private String ovaldays;
    @SerializedName("10")
    @Expose
    private String _10;
    @SerializedName("Ostarttime")
    @Expose
    private String ostarttime;
    @SerializedName("11")
    @Expose
    private String _11;
    @SerializedName("Oendtime")
    @Expose
    ...
    public String getOvaldays() {
        return ovaldays;
    }

    public void setOvaldays(String ovaldays) {
        this.ovaldays = ovaldays;
    }
